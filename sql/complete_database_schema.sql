...
-- This file creates all necessary tables from scratch
-- Run this file if your database is empty or if tables are missing
...
INSERT IGNORE INTO `departments` (`department_id`, `department_name`, `description`, `created_at`) VALUES
...
--
-- Insert sample data for complaint_categories
--

INSERT IGNORE INTO `complaint_categories` (`category_id`, `category_name`, `description`, `created_at`) VALUES
